...
namespace SolidFramework { namespace Platform { namespace Plumbing {
    ...
    public:
        ...
        void SetRotationSize(const unsigned long rotationSize);
    };
...
namespace SolidFramework {
    ...
    protected:
        HANDLE cPtr;
        bool ownsMemory;
        void Wrap(HANDLE cPtr, bool ownsMemory);
...
namespace SolidFramework { namespace Imaging { 
    ...
    enum class ImageEncoder {
        ...
        // Encoder is J2K
        J2KEncode = 8,
        // Encoder is CCITT Fax (Group3)
        CCITTFaxEncodeGroup3 = 9,
        // Encoder is CCITT Fax (Group4)
...
namespace SolidFramework { namespace Imaging { namespace Plumbing { 
    ...
    enum class ImageCompression {
        // Unknown   Compression
        Unknown = 0,
        // components will be returned as 24 bpp RGB, 8/4/2 bpp gray, 8/4 bpp indexed color or mono
        ColorOrBetter = 1,
        // components will be returned as 4/2 bpp gray or mono
        GrayOrBetter = 2,
        // components will be returned as 1 bpp mono
        Mono = 3,
        // components will be returned as 1 bpp mono
        FakeMono = 4,
        // components will be returned as 4/2 bpp gray or mono
        RealGrayOrBetter = 5,
        // components will be returned as a single lossless compressed image
        Lossless = 6,
...
namespace SolidFramework { namespace Model { namespace Pdf { namespace Pages { 
    ...
    enum class ModelOperation {
        // Type of Model   is Undefined.
        Undefined = 0,
        // Type of Model   is Insert.
        Insert = 1,
        // Type of Model   is Move.
        Move = 2,
        // Type of Model   is Copy.
        Copy = 3,
        // Type of Model   is Rotate.
        Rotate = 4,
        // Type of Model   is Delete.
        Delete = 5,
        // Type of Model   is Undo.
        Undo = 6,
        // Type of Model   is Redo.
        Redo = 7,
        AddComment = 8,
        DeleteComment = 9,
        ModifyComment = 10,
...
namespace SolidFramework { namespace Model { namespace Pdf { namespace Pages { namespace Plumbing { 
    ...
    // This enum provides internal support for the
    ...
    // This class primarily provides internal support for the .
    ...
    // This class primarily provides internal support for the  and  forms.
...
namespace SolidFramework { namespace Converters { 
    ...
    public:
        ...
        void AddSourceFiles(std::vector<std::wstring> paths);
...
namespace SolidFramework { namespace Converters { 
    ...
    public:
        ...
        // Gets a value indicating whether to highlight low confidence words (any word with  less than 100) in the OCR output in yellow.
        // This property has no effect if OCR has not occurred. Default is false.
        bool GetTextRecoverySuspects();

        // Sets a value indicating whether to highlight low confidence words (any word with  less than 100) in the OCR output in yellow.
        // This property has no effect if OCR has not occurred. Default is false.
...
namespace SolidFramework { namespace Converters { 
    ...
    public:
        ...
        // Starts the conversion of a PDF file to a text document.
        virtual void Convert();
...
namespace SolidFramework { namespace Converters { 
    ...
    public:
        ...
        // Get or sets a  that specifies the footnotes mode. Default is FootnotesMode.Ignore.
        Plumbing::FootnotesMode GetFootnotesMode();

        // Get or sets a  that specifies the footnotes mode. Default is FootnotesMode.Ignore.
        void SetFootnotesMode(Plumbing::FootnotesMode value);

        // Get or sets a  that specifies the header and footer mode. Default is HeaderAndFooterMode.Remove.
...
namespace SolidFramework { namespace Converters { 
    ...
    public:
        ...
        // Gets a  that specifies embed ot not font programs to output document. Default is EmbedFontsMode.NoFontEmbedding.
...
namespace SolidFramework { namespace Converters { 
    ...
    public:
        ...
        // Get or sets a  that specifies the header and footer mode. Default is FootnotesMode.Ignore.
        Plumbing::FootnotesMode GetFootnotesMode();

        // Get or sets a  that specifies the header and footer mode. Default is FootnotesMode.Ignore.
        void SetFootnotesMode(Plumbing::FootnotesMode value);

        // Get or sets a  that specifies the header and footer mode. Default is HeaderAndFooterMode.Detect.
        Plumbing::HeaderAndFooterMode GetHeaderAndFooterMode();

        // Get or sets a  that specifies the header and footer mode. Default is HeaderAndFooterMode.Detect.
        void SetHeaderAndFooterMode(Plumbing::HeaderAndFooterMode value);

        // Get or sets a  that specifies the header and footer mode. Default is ImageAnchoringMode.Automatic.
        ...
        // Get or sets a  that specifies how Markup Annotations should be converted. Default is MarkupAnnotConversionType.TextBox.
        Plumbing::MarkupAnnotConversionType GetMarkupAnnotConversionType();
        ...
        // Gets the  reconstruction mode. Default is ReconstructionMode.Flowing.
        Plumbing::ReconstructionMode GetReconstructionMode();

        // Sets the  reconstruction mode. Default is ReconstructionMode.Flowing.
...
namespace SolidFramework { namespace Converters { namespace Plumbing { 
    ...
    public:
        ...
        // Gets the paths
        void SetPaths(std::vector<std::wstring> value);
        ...
        // Gets the source file
        void SetSource(std::wstring value);
...
namespace SolidFramework { namespace Converters { namespace Plumbing { 
    ...
    public:
        ...
        // Gets a value indicating whether this  is background.
        bool GetBackground();

        // Sets a value indicating whether this  is background.
        ...
        // Gets a value indicating whether this  is strokde.
        bool GetStroke();
...
namespace SolidFramework { namespace Imaging { 
    ...
    public:
        ...
        // Adds a word to the custom dictionary for the lifetime of this   session. Useful for domain specific names or terminology.
...
namespace SolidFramework { namespace Imaging { 
    ...
    {
    public:
        OcrLine(std::vector<SolidFramework::Imaging::OcrWordPtr> words);
...
namespace SolidFramework { namespace Imaging { 
    ...
    public:
        ...
        // Gets a value indicating whether this  is of high recognition confidence.
        int GetConfidence();
...
namespace SolidFramework { namespace Interop { 
    ...
    public:
        ...
        void SetPalette(std::vector<SolidFramework::Interop::ColorPtr> value);
...
namespace SolidFramework { namespace Interop { 
    ...
    public:
        ...
        DateTime(SolidFramework::Interop::DateTimePtr date);
...
namespace SolidFramework { namespace Interop { 
    ...
    public:
        PointF();
        PointF(SolidFramework::Interop::PointFPtr value);
...
namespace SolidFramework { namespace Interop { 
    ...
    public:
        Rectangle();
        Rectangle(SolidFramework::Interop::RectanglePtr value);
...
namespace SolidFramework { namespace Interop { 
    ...
    public:
        RectangleF();
        RectangleF(SolidFramework::Interop::RectangleFPtr value);
...
namespace SolidFramework { namespace Interop { 
    ...
    public:
        SizeF();
        SizeF(SolidFramework::Interop::SizeFPtr value);
...
namespace SolidFramework { 
    ...
    public:
        ...
        // Checks if the current license has the required .
...
namespace SolidFramework { namespace Model { 
    ...
    public:
        ...
        // Creates a  object based on the file that is located at .
        ...
        // Exports the contents of the Model as an Excel, PowerPoint or Word Document at the location specified in . Fails if the destination file already exists.
        void Export(std::wstring path);

        // Exports the contents of the Model as an Excel, PowerPoint or Word Document at the location specified in .
        void Export(std::wstring path, bool overwrite);

        // Exports the contents of the Model to the location specified in .
        ...
        // Creates a  object from a native model handle.
...
namespace SolidFramework { namespace Model { namespace Layout { 
    ...
    public:
        ...
        // Gets the collection of  objects that are in the LayoutChunkLine.
        std::vector<LayoutChunkPtr> GetChunks();

        // Gets the number of  objects that are in the LayoutChunkLine.
        int GetCount();
    }; // LayoutChunkLine
...
namespace SolidFramework { namespace Model { namespace Layout { 
    ...
    public:
        ...
        // Gets the number of  objects that are in the LayoutChunkParagraph.
        int GetCount();

        // Gets the collection of  objects that are in the LayoutChunkParagraph.
...
namespace SolidFramework { namespace Model { namespace Layout { 
    ...
    public:
        ...
        // Gets the number of  within the document.
        int GetCount();

        LayoutObjectPtr FindLayoutObject(int val);

        // Gets the collection of  within the document.
...
namespace SolidFramework { namespace Model { namespace Layout { 
    ...
    public:
        ...
        SolidFramework::Interop::MatrixPtr GetTransform();
    }; // LayoutObject
...
namespace SolidFramework { namespace Model { namespace Layout { 
    ...
    public:
        ...
        // Gets the ID of the  object that this object refers to.
        virtual int GetID();
...
namespace SolidFramework { namespace Model { namespace Layout { 
    ...
    public:
        ...
        // Gets the number of  objects that are contained within the group.
        int GetCount();

        // Gets the ID of the  object that this object refers to.
        virtual int GetID();

        // Gets the collection of  objects that are contained within the group.
        virtual std::vector<LayoutObjectPtr> GetLayoutObjects();
...
namespace SolidFramework { namespace Model { namespace Layout { 
    ...
    public:
        ...
        // Gets the number of  objects that are contained within the page.
        int GetCount();

        // This function always returns zero.
        virtual int GetID();

        // Gets the collection of  objects that are contained within the page.
        virtual std::vector<LayoutObjectPtr> GetLayoutObjects();
...
namespace SolidFramework { namespace Model { namespace Layout { 
    ...
    public:
        ...
        // Gets the collection of  objects that are contained within the paragraph.
        virtual std::vector<LayoutObjectPtr> GetLayoutObjects();
...
namespace SolidFramework { namespace Model { namespace Layout { 
    ...
    public:
        ...
        // Gets the number of  objects that are contained within the line.
        int GetCount();

        // This function always returns zero.
        virtual int GetID();

        // Gets the collection of   objects that are contained within the line.
        virtual std::vector<LayoutObjectPtr> GetLayoutObjects();
...
namespace SolidFramework { namespace Model { namespace Layout { 
    ...
    // NOTE: a  does not map directly to a .
...
namespace SolidFramework { namespace Model { namespace Layout { 
    ...
    public:
        ...
        // Gets the number of  objects that are contained within the table.
        int GetCount();

        // Gets the ID of the Table object that this object refers to.
        virtual int GetID();

        // Gets the collection of  objects that are contained within the table.
        virtual std::vector<LayoutObjectPtr> GetLayoutObjects();
...
namespace SolidFramework { namespace Model { namespace Pdf { namespace Pages { 
    ...
    public:
        ...
        // Gets the angle by which the  is rotated.
        int GetRotation();

        // Sets the angle by which the  is rotated.
...
namespace SolidFramework { namespace Model { namespace Pdf { namespace Pages { 
    ...
    public:
        ...
        // The location of the comment. This consists of a PointFsCollection containing exactly 4 points representing the location of the  bottom-left, bottom-right, top-left and top-right of the comment.  
        // The color of the comment.
        // The title of the comment. By convention this should be the name of the person who made the change.
        // The text that is to be associated with the comment.
        Plumbing::CommentPtr AddHighlightComment(std::vector<SolidFramework::Interop::PointFPtr> location, SolidFramework::Interop::ColorPtr color, std::wstring title, std::wstring content);
        ...
        // The title of the comment. By convention this should be the name of the person who made the change.
        // The text that is to be associated with the comment.
        Plumbing::CommentPtr AddStrikeOutComment(std::vector<SolidFramework::Interop::PointFPtr> location, SolidFramework::Interop::ColorPtr color, std::wstring title, std::wstring content);
        ...
        // The title of the comment. By convention this should be the name of the person who made the change.
        // The text that is to be associated with the comment.
        Plumbing::CommentPtr AddTextComment(std::vector<SolidFramework::Interop::PointFPtr> location, SolidFramework::Interop::ColorPtr color, std::wstring title, std::wstring content);

        // Adds a text comment to an existing comment.
        // The existing comment to which the new comment should be attached.  
        // The title of the comment. By convention this should be the name of the person who made the change.
        // The text that is to be associated with the comment.
        ...
        // The title of the comment. By convention this should be the name of the person who made the change.
        // The text that is to be associated with the comment.
        Plumbing::CommentPtr AddUnderlineComment(std::vector<SolidFramework::Interop::PointFPtr> location, SolidFramework::Interop::ColorPtr color, std::wstring title, std::wstring content);
        ...
        bool ModifyComment(Plumbing::CommentPtr comment, std::vector<SolidFramework::Interop::PointFPtr> newLocation, SolidFramework::Interop::ColorPtr newColor, std::wstring newTitle, std::wstring newContent);
...
namespace SolidFramework { namespace Model { namespace Pdf { namespace Pages { 
    ...
    public:
        ...
        // Gets a value indicating whether this  is clear.
        bool GetClear();

        // Gets the event.
        ModelChangedEvent GetEvent();

        // Gets a value indicating whether this  is rotation.
        bool GetRotation();
    }; // ModelChangedEventArgs
...
namespace SolidFramework { namespace Model { namespace Pdf { namespace Pages { namespace Operations { 
    ...
    public:
        ...
        // Executes the copying of the current selection within the document.                                                
        // Note: before calling this method, the selection must be specified in the page model.
        virtual bool Execute(SolidFramework::Model::Pdf::Pages::ParameterPtr parameter);
...
namespace SolidFramework { namespace Model { namespace Pdf { namespace Pages { namespace Operations { 
    ...
    public:
        ...
        // Executes the deletion of the current selection within the document.
        // Note: before calling this method, the selection must be specified in the page model.
        virtual bool Execute();
...
namespace SolidFramework { namespace Model { namespace Pdf { namespace Pages { namespace Operations { 
    ...
    public:
        ...
        // Executes the insertion of the pages in source into the Pages Model.
        virtual bool Execute(SolidFramework::Model::Pdf::Pages::ParameterPtr parameter);
...
namespace SolidFramework { namespace Model { namespace Pdf { namespace Pages { namespace Operations { 
    ...
    public:
        ...
        // Executes the moving of the current selection within the document.
        // Note: before calling this method, the selection must be specified in the page model.
        virtual bool Execute(SolidFramework::Model::Pdf::Pages::ParameterPtr parameter);
...
namespace SolidFramework { namespace Model { namespace Pdf { namespace Pages { namespace Operations { 
    ...
    public:
        ...
        // Removes the first operation on the Undo stack if there is one and redoes it. Otherwise nothing happens.
        virtual bool Execute();
...
namespace SolidFramework { namespace Model { namespace Pdf { namespace Pages { namespace Operations { 
    ...
    public:
        ...
        // Executes the rotation of the current selection within the document.
        // Note: before calling this method, the selection must be specified in the page model.
        virtual bool Execute(SolidFramework::Model::Pdf::Pages::ParameterPtr parameter);
...
namespace SolidFramework { namespace Model { namespace Pdf { namespace Pages { namespace Operations { 
    ...
    public:
        ...
        // Undeos the most recent operation that has been executed on the PagesModel, and adds the operation tothe UndoStack.
        virtual bool Execute();
...
namespace SolidFramework { namespace Model { namespace Pdf { namespace Pages { 
    ...
    public:
        ...
        virtual void InsertRange(int position, std::vector<SolidFramework::Model::Pdf::Pages::IPageSourcePtr> collection);

        virtual void InsertRange(int insert, std::vector<SolidFramework::Model::Pdf::Pages::IPageHolderPtr> collection);

        virtual void InsertRange(int position, std::vector<std::wstring> pageFiles, bool preferPdfAWhenCreating);
        ...
        // Gets a value indicating whether this  is modified.
        bool GetModified();
        ...
        // Gets the page selections.
        void SetPageSelections(std::vector<SolidFramework::Model::Pdf::Pages::PageSelectionPtr> value);
        ...
        // Gets the selection.
        void SetSelection(std::vector<int> value);
        ...
        void ValidateIndices(std::vector<int> indices);
...
namespace SolidFramework { namespace Model { namespace Pdf { namespace Pages { namespace Operations { 
    ...
    {
    public:
        AddCommentParameter(SolidFramework::Model::Pdf::Pages::IPageHolderPtr page, SolidFramework::Model::Pdf::Pages::Plumbing::AnnotationType type, std::vector<SolidFramework::Interop::PointFPtr> position, SolidFramework::Interop::ColorPtr color, std::wstring title, std::wstring content);
...
namespace SolidFramework { namespace Model { namespace Pdf { namespace Pages { namespace Operations { 
    ...
    public:
        ...
        InsertParameter(int position, std::vector<SolidFramework::Model::Pdf::Pages::IPageSourcePtr> sources);
...
namespace SolidFramework { namespace Model { namespace Pdf { namespace Pages { namespace Operations { 
    ...
    {
    public:
        ModifyCommentParameter(SolidFramework::Model::Pdf::Pages::Plumbing::CommentPtr modifiedComment, std::vector<SolidFramework::Interop::PointFPtr> position, SolidFramework::Interop::ColorPtr color, std::wstring title, std::wstring content);
        ModifyCommentParameter(SolidFramework::Model::Pdf::Pages::Plumbing::CommentPtr modifiedComment, std::vector<SolidFramework::Interop::PointFPtr> position);
...
namespace SolidFramework { namespace Model { namespace Pdf { namespace Pages { namespace Plumbing { 
    ...
    // This class provides internal support for the
...
namespace SolidFramework { namespace Model { namespace Pdf { namespace Pages { namespace Plumbing { 
    ...
    // This class primarily provides internal support for the  form.
...
namespace SolidFramework { namespace Model { namespace Pdf { namespace Pages { namespace Plumbing { 
    ...
    public:
        ...
        // Gets a value indicating whether this  has been modified.
        bool GetModified();

        // Sets a value indicating whether this  has been modified.
...
namespace SolidFramework { namespace Model { namespace Pdf { namespace Pages { namespace Plumbing { 
    ...
    // This class primarily provides internal support for the  and  forms.
    // However it can also be accessed from the  object.
...
namespace SolidFramework { namespace Model { namespace Plumbing { 
    ...
    // A smooth curve that is defined by its start and end points and two control points or handles. A  is a combination of linked Bezier or line segments.
...
namespace SolidFramework { namespace Model { 
    ...
    public:
        ...
        // Get or sets a  that specifies whether the document, or just images, or just tables should be converted . Default is ConvertMode.Document.
        ...
        // Get or sets a  that specifies how tables should be handled when exporting to Excel. Default is ExcelTablesOnSheet.PlaceEachTableOnOwnSheet.
        ...
        // Gets a  that specifies the markup annotation mode. Default is MarkupAnnotConversionType.TextBox.
        SolidFramework::Converters::Plumbing::MarkupAnnotConversionType GetMarkupAnnotConversionType();

        // Sets a  that specifies the markup annotation mode. Default is MarkupAnnotConversionType.TextBox.
        ...
        // Get or sets a  that specifies the file reconstruction mode. The default is ReconstructionMode.Flowing.
        ...
        // Get or sets a  that specifies when OCR is used. Default is TextRecovery.Automatic.
        ...
        // Get or sets a  that specifies the text recovery engine to be used for OCR. Default is TextRecoveryEngine.Automatic.
        ...
        // Get or sets a  that specifies the text recovery engine to be used for OCR when dealing with non-standard encoding. 
        ...
        // Get or sets a  that specifies whether OCR is used for characters with non-standard encoding. Default is TextRecoveryNSE.Automatic.
...
namespace SolidFramework { namespace Model { namespace Plumbing { 
    ...
    public:
        ...
        // Gets the  that is associated with the paragraph. This will be null if the paragraph is not part of a list.
        ListPtr GetAttachedList();

        int GetAttachedListLevel();

        // Gets the number of  objects that are in the Paragraph.
        int GetCount();

        // Gets the collection of  objects that are in the Paragraph.
...
namespace SolidFramework { namespace Model { namespace Plumbing { 
    ...
    public:
        ...
        // Gets the number of  within the group.
        int GetCount();

        // Gets the collection of  within the group.
...
namespace SolidFramework { namespace Model { namespace Plumbing { 
    ...
    public:
        ...
        // Gets the number of  within the textbox.
        int GetCount();
        ...
        // Gets the collection of  within the textbox.
        virtual std::vector<SolidObjectPtr> GetSolidObjects();
...
namespace SolidFramework { namespace Model { namespace Plumbing { 
    ...
    public:
        ...
        // Gets the color used for the page border in this section.
...
namespace SolidFramework { namespace Model { namespace Plumbing { 
    ...
    public:
        ...
        // Gets a  that specifies the position of the characters (superscript/subscript/normal).
...
namespace SolidFramework { 
    ...
    {
    public:
        PageRange(std::vector<int> range);
...
namespace SolidFramework { namespace Pdf { namespace Plumbing { 
    ...
    public:
        ...
        // Determines if the page is contains hidden text (text render mode 3 used for searchable text in scanned documents).
        ...
        // Determines if the page is contains vector text (typically drawn by CAD) which would need OCR.
        bool IsVectorText();
...
namespace SolidFramework { namespace Pdf { namespace Plumbing { 
    ...
    public:
        ...
        // Gets the raw value.
        void SetRawValue(std::wstring value);
...
namespace SolidFramework { namespace Pdf { namespace Transformers { 
    ...
    public:
        ...
        SolidFramework::Pdf::PdfDocumentPtr GetDocument();

        bool IsEqual(ITransformationResultPtr value);

        // Result of transformation
        SolidFramework::Interop::NativeError GetStatus();
    }; // ITransformationResult
...
namespace SolidFramework { namespace Platform { 
    ...
    public:
        ...
        static bool SetAppDataDirectory(std::wstring path);
        ...
        static bool SetCMapDirectory(std::wstring path);

        static std::wstring GetColorProfileDirectory();

        static bool SetColorProfileDirectory(std::wstring path);

        static std::wstring GetFontDirectory();

        static bool SetFontDirectory(std::wstring path);

        static std::wstring GetFontsDataBaseFile();

        static bool SetFontsDataBaseFile(std::wstring path);
...
namespace SolidFramework { namespace Pdf { 
    ...
    public:
        ...
        SolidFramework::Plumbing::ICatalogPtr GetCatalog();
...
namespace SolidFramework { namespace Pdf { 
    ...
    public:
        ...
        SolidFramework::Plumbing::IPagesCollectionPtr GetPages();
